...
class Caption:
    ...
    def detect_bilingual_mode(self) -> BilingualMode:
        ...
        Thin wrapper around :func:`lattifai.caption.bilingual.detect_bilingual_mode`.
        See that function for the full priority and coverage-floor rules.
        """
        return _detect_bilingual_mode(self.supervisions, self.source_format)
